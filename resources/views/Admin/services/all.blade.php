        ...
        <div class="container-fluid">
            <div class="inner-body">
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">مدیریت خدمات</h2>
                        <ol class="breadcrumb">
                ...
                <div class="row row-sm">
                    <div class="col-lg-12">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <div>
                                    <h6 class="main-content-label mb-1">لیست خدمات </h6>
                                    <a href="{{url('admin/services/create')}}" class="btn btn-primary btn-xs">افزودن خدمات جدید</a>
                                </div>
                                    ...
                                    <table class="table" id="example1">
                                        ...
                                        @foreach($services as $service)
                                            <tr class="odd gradeX">
                                                <td>{{$x++}}</td>
                                                <td>
                                                    <img src="{{asset($service->images)}}" class="img-responsive" style="display: block" width="30" alt="">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-icon-list">
                                                        <a href="{{ route('services.edit' , $service->id ) }}" class="btn ripple btn-outline-info btn-icon">
