@extends('Admin.admin')
@section('title')
    <title> ایجاد زیرمجموعه خدمات </title>
                ...
                <div class="page-header">
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('admin/services')}}">مدیریت  زیرمجموعه خدمات</a></li>
                            <li class="breadcrumb-item active" aria-current="page">ایجاد زیرمجموعه خدمات</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-sm">
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                <div>
                                    <h6 class="main-content-label text-center mb-5">ورود اطلاعات زیرمجموعه خدمات</h6>
                                </div>
                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" data-required="1" placeholder="نام خدمات را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="service_id" class="form-control select-lg select2">
                                                    <option value="">انتخاب خدمات اصلی</option>
