...
@section('title')
    <title>تایید شماره همراه کاربران کلینیک الماس</title>
                                    ...
                                    <div class="message-light">
                                        <div class="massege-light-send">
                                            ...
                                            <div class="form-edit-number text-center">
                                                <a href="{{url('login')}}" class="edit-number-link">ویرایش شماره</a>
                                            </div>
                                        </div>
                                        <form method="POST" action="{{ route('verify.phone.token') }}" class="form-account">
                                            ...
                                            <div class="form-account-title">
                                                ...
                                                <input type="text" name="code" value="{{ old('code') }}" class="number-email-input @error('code') is-invalid @enderror" maxlength="6">
                                            </div>
