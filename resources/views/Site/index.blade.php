        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="almas-banner-text">
                    ...
                    <p>کلینیک تخصصی زیبایی الماس با مدیریت دکتر غلامرضا کریمی ، جهت مشاوره زیبایی با ما تماس حاصل نمایید همچنین تعیین وقت از طریق لینک زیر به صورت آنلاین نوبت دریافت نمایید .</p>
